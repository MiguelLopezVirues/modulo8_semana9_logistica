...
class AnalisisModelosClasificacion:
    def __init__(self, dataframe, variable_dependiente, seed=42):
        ...
        self.resultados = {nombre: {"mejor_modelo": None, "pred_train": None, "pred_test": None, "pred_test_prob": None} for nombre in self.modelos}
